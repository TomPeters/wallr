...
{
    public interface IImageSourceProvider // todo: Implement
    {
//        IEnumerable<string> AvailableSourceTypes { get; }
//        IImageSource GetSource(ImageSourceType sourceType);
    }

    public class ImageSourceProvider : IImageSourceProvider
         {
//        private readonly Lazy<IEnumerable<string>> _availableSourceTypes = new Lazy<IEnumerable<IImageSource>>(FindAvailableSourceTypes);
//
...
//
//        public IImageSource GetSource(ImageSourceType sourceType) => AvailableSourceTypes.First(s => s.SourceTypeName.Equals(sourceType));
    }
}